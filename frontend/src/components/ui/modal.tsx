			...
			{open ? (
				<motion.div
					...
					<motion.div
						...
						className={`relative w-full ${maxWidthClassName} rounded-2xl border-2 border-black bg-[#E1DED9] text-[#080502] shadow-[0_20px_60px_rgba(0,0,0,0.45)]`}
						initial={{ opacity: 0, scale: 0.98, y: 8 }}
						animate={{ opacity: 1, scale: 1, y: 0 }}
						exit={{ opacity: 0, scale: 0.98, y: 8 }}
						transition={{ type: 'spring', stiffness: 520, damping: 38 }}>
						<div className='flex items-center justify-between border-b-2 border-black/40 px-5 py-3'>
