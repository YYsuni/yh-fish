...
import { postPianoStart, postPianoStop } from '../../lib/api-client'
...
export type PianoRemote = ReturnType<typeof usePianoStatus>

export function PianoControls({ piano }: { piano: PianoRemote }) {
	const { status, refresh } = piano
